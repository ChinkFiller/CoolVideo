    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5" v-if="false">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['video:function:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="跳转链接" prop="href">
          <el-input v-model="form.href" placeholder="请输入跳转链接" />
        </el-form-item>
...
<script>
import { listFunction, getFunction, delFunction, addFunction, updateFunction } from "@/api/video/function";
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: {
        img: [{ required: true, message: "图标不能为空", trigger: "blur" }],
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除主页快速功能编号为"' + fids + '"的数据项？').then(function() {
        return delFunction(fids)
      }).then(() => {
        this.getList()
